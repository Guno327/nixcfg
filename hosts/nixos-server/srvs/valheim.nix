      ...
      services.valheim =
        ...
        in
        {
          ...
          script = ''
            ...
            ${steam-run} /var/lib/valheim/valheim_server.x86_64 -name "ghov" -port 2456 -nographics -batchmode -world "ghov" -password "$VALHEIM_PASSWD" -public 1 -savedir /var/lib/valheim/save_data 
